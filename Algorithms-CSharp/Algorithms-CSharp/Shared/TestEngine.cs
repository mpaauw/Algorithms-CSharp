...
namespace Algorithms_CSharp.Shared
{
    ...
    public class TestEngine
    {
        ...
        private void populateArray()
        {
            ...
            {
                this.elements[i] = generateFullyRandomElementDomainBound();
            }
        }

        /// <summary>
        /// Generates a random integer within the range of a provided value.
        /// Public access so single random values can be generated by inheriting classes.
        /// </summary>
        /// <returns>Returns an integer value.</returns>
        public int generateRandomElementBound(int range)
        {
            return this.random.Next(range);
        }
        ...
        /// </summary>
        /// <returns>Returns an integer value.</returns>
        public int generateFullyRandomElementDomainBound()
        {
